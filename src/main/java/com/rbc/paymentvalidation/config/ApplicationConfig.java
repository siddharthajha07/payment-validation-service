...
/**
 * Beans that are not components in their own right.
 */
@Configuration
public class ApplicationConfig {
     ...
     *
     * Exposing the clock as a bean rather than letting classes call now()
     ...
     *
     * UTC rather than the system default deliberately: settlement dates are scheme
